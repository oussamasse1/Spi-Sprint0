...
public class EnseignantController {
	...
	@RequestMapping(method = RequestMethod.POST, value = "/enseignant")
    public void creer(@RequestBody Enseignant E) {
	...
	@GetMapping(value = "/enseignant/{noEnseignant}")
    public Enseignant getDataByNoEnseignant(@PathVariable long noEnseignant) {
		return business.getEnseignant(noEnseignant).get(0); 
    }
	...
	@RequestMapping(method = RequestMethod.PUT, value = "/enseignant")
    public void update(@RequestBody Enseignant E) {
		
		business.updateEnseignant(E);
		}
